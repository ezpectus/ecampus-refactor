    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-neutral-50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-6xl">
          <Heading2 className="mb-12 text-center text-3xl font-bold text-neutral-900">{t('features.title')}</Heading2>
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              ...
              >
                ...
                <Heading3 className="mb-2 text-xl font-semibold text-neutral-900">{feature.title}</Heading3>
                <Paragraph className="text-neutral-600">{feature.description}</Paragraph>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="px-6 py-20 text-center md:py-28">
        <Heading2 className="mb-6 text-3xl font-bold text-neutral-900">{t('cta.title')}</Heading2>
        <Paragraph className="mx-auto mb-10 max-w-2xl text-lg text-neutral-600">{t('cta.description')}</Paragraph>
        <Link href="/register">
          <Button variant="primary" size="big">
            {t('cta.button')}
          </Button>
