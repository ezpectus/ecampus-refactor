  ...
  switch (id) {
            ...
            <Card key={metric.key}>
              <CardContent className="flex items-center gap-3 p-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-xs">{t(`metrics.${metric.key}`)}</p>
                </div>
              </CardContent>
            </Card>
          ))}
    ...
    case 'cohorts':
      return (
        <Card className="col-span-12">
          <CardHeader>
            <CardTitle>{t('charts.cohorts')}</CardTitle>
          </CardHeader>
          <CardContent>
            {cohorts.length > 0 ? (
              <ResponsiveContainer width="100%" height={300}>
    ...
    case 'curriculum-analytics':
      return (
        <Card className="col-span-12">
          <CardHeader>
            <CardTitle>{t('charts.curriculum-analytics')}</CardTitle>
          </CardHeader>
          <CardContent>
            {courseRisk.length > 0 ? (
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={courseRisk} layout="vertical">
                  ...
                  <Tooltip
                    ...
                    formatter={(value) => [`${value}%`, t('charts.failure-rate')]}
                  />
    ...
    case 'teacher-effectiveness':
      return (
        <Card className="col-span-12">
          <CardHeader>
            <CardTitle>{t('charts.teacher-effectiveness')}</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            {riskStudents.length > 0 ? (
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={riskStudents} layout="vertical">
                  ...
                  <Tooltip
                    contentStyle={{ borderRadius: 8, border: '1px solid #e5e7eb' }}
                    formatter={(value) => [`${value}%`, t('charts.risk-score')]}
                  />
